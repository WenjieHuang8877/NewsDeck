...
public class SaveFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //create a new ItemTouchHelper to use the SwipeToDeleteCallback
        // attach it to the recyclerview;
//        SwipeToDeleteCallback swipeToDeleteCallback = new SwipeToDeleteCallback(savedNewsAdapter);
//
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemMoveCallback(savedNewsAdapter));
        itemTouchHelper.attachToRecyclerView(binding.newsSavedRecyclerView);
        ...
        savedNewsAdapter.setItemCallback(new SavedNewsAdapter.ItemCallback() {
                                             ...
                                             public void onOpenDetails(Article article) {
                                                 ...
                                                 //passed in the article in the navigation direction,
                                                 ...
                                                 // then call the navigate with the direction.
